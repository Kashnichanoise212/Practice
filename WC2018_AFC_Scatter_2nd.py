...
trace_2= graph.Scatter(x = df1["weighted age by min"], y = df1["weighted height by min"], mode = 'markers', name="Average_weighted by playing minutes", text= naming, marker=dict(size =30, color=coloring), opacity=0.6)
trace_3= graph.Scatter(x = df1["Ave. A w/o 0min"], y = df1["Ave. H w/o 0min"], mode = 'markers', name="Average_without no-playing(0min) players", text= naming, marker=dict(size =30, color=coloring), opacity=0.45)
trace_4= graph.Scatter(x = df1["Ave. A w/o GK&0min"], y = df1["Ave. H w/o GK&0min"], mode = 'markers', name="Average_without Goal keepers & no-playing(0min) players", text= naming, marker=dict(size =30, color=coloring), opacity=0.3)

...
#Reading CSV
df = pd.read_csv("AFC_WC2018_Players_data.csv")
...
layout = graph.Layout(width=800*1.2, height=450*1.2, xaxis = dict(title="age", range = [15,40], dtick=10), yaxis = dict(title="height", range = [160,200], dtick=10))
